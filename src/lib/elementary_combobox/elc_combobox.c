...
static const char SIG_WIDGET_LANG_CHANGED[] = "language,changed";
static const char SIG_WIDGET_ACCESS_CHANGED[] = "access,changed";
...
_elm_combobox_elm_widget_translate(Eo *obj EINA_UNUSED, Elm_Combobox_Data *sd)
{
   ...
   eo_do_super(sd->genlist, MY_CLASS, elm_obj_widget_translate());
   eo_do_super(sd->entry, MY_CLASS, elm_obj_widget_translate());

   if (sd->hover)
     eo_do_super(sd->hover, MY_CLASS, elm_obj_widget_translate());
                  ...
                  void *event_info EINA_UNUSED)
{
   ...
   dismissstr = elm_layout_data_get(elm_layout_edje_get(obj), "dismiss");
                       ...
                       void *event_info EINA_UNUSED)
{
   ...
   eo_do(data, eo_event_callback_call(ELM_COMBOBOX_EVENT_FILTER_DONE, event_info));
...
_elm_combobox_evas_object_smart_add(Eo *obj, Elm_Combobox_Data *sd EINA_UNUSED)
{
   ...
   eo_do_super(obj, MY_CLASS, elm_obj_widget_theme_apply());
}
...
_elm_combobox_eo_base_constructor(Eo *obj, Elm_Combobox_Data *sd)
{
   ...
   eo_do(gl, eo_event_callback_add(ELM_GENLIST_EVENT_FILTER_DONE, _gl_filter_finished_cb, obj));
   ...
   eo_do(entry,
         eo_event_callback_array_add(entry_callbacks(), obj));
...
_elm_combobox_hover_end(Eo *obj, Elm_Combobox_Data *sd)
{
   const char *dismissstr;
   if (!sd->hover) return;
   dismissstr = evas_object_data_get(sd->hover, "dismiss");
...
_key_action_activate(Evas_Object *obj, const char *params EINA_UNUSED)
{
   ...
   if (!sd->expanded)
     ...
     {
        eo_do(sd->genlist, eo_event_callback_call(EVAS_CLICKABLE_INTERFACE_EVENT_PRESSED, sd->item));
...
EOLIAN static Eina_Bool
_elm_combobox_elm_widget_event(Eo *obj EINA_UNUSED, Elm_Combobox_Data *sd,
