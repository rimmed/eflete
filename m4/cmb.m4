...
dnl CMB_VERSION(major, minor, micro, release)
dnl This setup CMB version information and should be called BEFORE AC_INIT().
dnl
...
dnl
CMB_LTLIBRARY_FLAGS="-no-undefined -version-info lt_cur:lt_rev:lt_age v_rel"
AC_SUBST(CMB_LTLIBRARY_FLAGS)dnl
CMB_LTMODULE_FLAGS="-no-undefined -avoid-version"
AC_SUBST([CMB_LTMODULE_FLAGS])dnl
